...
public class ReleaseDAO {
    ...
    public List<Release> findAllBySystemId(int systemid){
        List releases = sessionFactory.getCurrentSession().createQuery("from Release s where s.system.id=?").setParameter(0, systemid).list();
        return releases;
    }
