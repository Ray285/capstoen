...
public class RevisionDAO {
    ...
    public Revision findByReportId(int id){
        return (Revision) this.sessionFactory.getCurrentSession().createQuery("from Revision s where s.report.id=?").setParameter(0, id).uniqueResult();
    }
