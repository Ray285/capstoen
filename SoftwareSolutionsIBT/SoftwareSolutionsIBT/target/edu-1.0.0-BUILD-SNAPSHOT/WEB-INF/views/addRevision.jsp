...
<body>	
	...
	<div class="container ">
    	...
    	<div class="row span12 well well-lg">
				<form:form modelAttribute="revision" action="showRevisions" method="POST">
					<table class="table well well-lg">
                        ...
                        <tr>
                            <td><form:label path="name">Revision Name</form:label></td>
                            <td><form:input path="name" required="required" type="text" class="form-control"/></td>
                        </tr>
							<td><form:label path="vcsid">ID in Version Control System</form:label></td>
							<td><form:input path="vcsid" required="required" type="text"/></td>
						</tr>
						<tr>
						    <td><form:label path="comment">Comment</form:label></td>
						    <td><form:textarea path="comment" required = "required" type = "text"/>
						</tr>
