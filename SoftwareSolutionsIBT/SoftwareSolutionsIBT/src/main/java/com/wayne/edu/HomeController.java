...
//    }
	...
	public  ModelAndView home(HttpServletRequest request) {
        ...
        String userName = "log in"; // Any default user  name
    ...
    public String addRevision(@RequestParam("id") int sysId, @ModelAttribute("revision")Revision revision, Model model) {

        System sys = systemService.retrieveSystem(sysId);
        revision.setSystem(sys);
    ...
    public String addReport(@RequestParam("id") int releaseId, @ModelAttribute("report")Report report, Model model) {
    ...
    public String addTargetChange(@RequestParam("id") int fileId, @ModelAttribute("change")Changes change, Model model) {
    ...
    public String change(Model model) {
        ...
        List<File> files = fileService.retrieveAllFiles();
    ...
    public String addFiles(@RequestParam("id") int revId, @ModelAttribute("Targetfile") File file, Model model) {
