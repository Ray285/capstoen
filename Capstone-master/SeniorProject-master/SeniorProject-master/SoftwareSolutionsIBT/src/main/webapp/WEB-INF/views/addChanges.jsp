        ...
        <form:form id="report" action="showReports" method="POST">
            <table class="table well well-lg">
                ...
                <tr>
                    ...
                    <td><form:select path="path" required="required">
                        <form:option value="">-- Select Target File</form:option>
                        <form:option value="{@path}">{@path}</form:option>
                    </form:select> <a href="/edu/addFile">Add new report</a></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td><form:label path="qname">Qualified name</form:label></td>
                    <td><form:textarea path="qname" required = "required" type = "text"/>
                </tr>
                <tr>
